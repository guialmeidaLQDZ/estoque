/**
 * ============================================================
 * LIQUIDZ — FINANCEIRO.gs — Projeto v1.6
...
function configurarToken() {
  // Token já salvo no PropertiesService — não reusar esta função sem necessidade.
  // Se precisar resetar: cole o token abaixo, rode uma vez e apague o valor.
  const TOKEN = "";
