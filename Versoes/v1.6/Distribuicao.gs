/**
 * ============================================================
 * LIQUIDZ — DISTRIBUIÇÃO.gs — Projeto v1.6
 * ============================================================
 *
 * Changelog v1.1:
 ...
 *
 * Changelog v1.6:
 * [FIX] lock.waitLock → tryLock para consistência com demais scripts
 *
 * Coluna K = STATUS LOGÍSTICA | Coluna L = STATUS FINANCEIRO | Coluna M = LOG_ERRO (interno, não exibido no AppSheet)
 */
...
function distribuirMovimentacoes() {
  ...
  if (!lock.tryLock(10000)) { console.warn("⚠️ distribuirMovimentacoes: outra execução em andamento, abortando."); return; }
